...
{
    public class NoneResultResultConverter : SupResultConverter, IResultConverter
    {
        public NoneResultResultConverter(string ipV4, string port, string remarks, DateTime receiveTime) 
