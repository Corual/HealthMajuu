...
{
    public class HostNotfoundResultConverter : SupResultConverter, IResultConverter
    {
        public HostNotfoundResultConverter(string ipV4, string port, string remarks, DateTime receiveTime) 
